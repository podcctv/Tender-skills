...
- Keep this folder under a workspace skill directory and explicitly ask: `Use $tender-bid-writer ...`.
- Copy or sync the `tender-bid-writer` folder into the Codex skills directory used by your environment.
